...
<td valign="bottom"><h1><xsl:value-of select="$tittel"/></h1></td><td><a href="http://www.kk-software.fi"><IMG alt="KK-Software" border="0" src="http://www.sukuohjelmisto.fi/fi/images/KK-Software.gif"/></a></td></tr></table>
  <hr/>
