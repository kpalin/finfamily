...
public class Import2004Test extends TestCase {
	...
	protected void setUp() { 
		ResourceBundle resources = ResourceBundle.getBundle("properties/junittests");
	 ...
	 */
	@Test public void testImportTesti() throws SukuException {
		
//		SukuServer server = new SukuServerImpl();
		SukuKontrollerLocalImpl kontroller = new SukuKontrollerLocalImpl();
	
		kontroller.getConnection(this.host, this.dbname, this.userid, this.password);
