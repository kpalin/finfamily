...
/**
 * The Java report is a separate window that receives the report
 * in a java TextPane format. This format is easy for the user 
 * and should be considered as a preview of the report
 * 
 * @author Kalle
 *
 */
