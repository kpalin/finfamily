 ...
 * 
 * <p>The descendant list creates an excel report of the subjects descendans in 
 * a compresssed format to give user a view of the database.</p>
 * 
 * <p>The report includes persons generation, birthyear, name and information
 * on selected notices that person has.</p>
 * 
 * @author Kalle
 *
 */
