 ...
 * 
 * <p>This is used both in server side and client side but 
 * are not transmitted between the two layers</p>
 * 
 * @author Kalle
 *
 */
public class PersonInTables {
	 ...
	 * Constructor
	 * 
	 * @param pid i.e. person id whom this concerns
	 */
	...
	public int getTypesColumn(long table,boolean alsoSpouse,
		...
		if (firstTable == 0 || firstTable == table) return 2;
		if (firstTable < table) return 2;
		return 3;
