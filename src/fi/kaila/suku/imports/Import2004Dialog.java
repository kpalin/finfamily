 ...
 * 
 * <p>The Suku 2004 backup file is an xml-file that contains all relevant
 * information in the Suku2004 database. The xml-file is usually packed 
 * in gzipped format</p>
 * 
 * <p>This is a Dialog window that is located in UI side. It runs a Worker thread
 * to display progress of the import. The import is executed in server side
 * by {@link fi.kaila.suku.imports.Read2004XML }. Setting up the import is done here.</p>
 * 
 * @author Kalle
 *
 */
public class Import2004Dialog extends JDialog implements ActionListener,PropertyChangeListener{
	 ...
	 * {@link fi.kaila.suku.kontroller.SukuKontroller kontroller interface} as parameters
	 * 
	 * @param owner
	 * @param kontroller
	 */
...
//	 * e.g. in different languages. In Suku11 database the different languages are 
//	 * stored in separate language pages. The user must choose the main language 
...
//                firePropertyChange("progress", "old", "" + progress + ";prgii[" + progress + "]");
//            }
            return null;
        }
...
//            taskOutput.append("Done!\n");
    ...
    /**
     * The runner is the progressbar on the import dialog. Set new values
     * to the progress bar using this command
     * 
     * the text may be split in two parts seperated by ";"
     * 
     * if the text is divided then part before ; must be an integer number between 0-100
     * for the progress bar. Text behind ; or if ; does not exist 
