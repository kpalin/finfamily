...
public class Resurses {
	...
	*/
	...
	public static final String TEST_SAVE = "TEST_SAVE";
	public static final String TEST_OPEN = "TEST_OPEN";
	...
	/**
	 * commands for getSukuData. All commands and their types should be collected here
	 */
