...
//	public static BufferedImage unknownIcon;
	...
	public void createSukuDb(Connection con) throws SukuException {
		...
		try {
			in = new InputStreamReader(this.getClass().getResourceAsStream("/sql/finfamily.sql"),"UTF-8");
...
//				System.out.println("sql:"+sql);
	 ...
	 * @throws SukuException 
	 */
	public Read2004XML import2004Data(Connection con,String path, String oldCode) throws SukuException{
