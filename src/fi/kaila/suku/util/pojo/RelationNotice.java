...
//	select a.rid,a.pid,b.pid,a.tag,rn.tag,rn.surety,rn.relationtype,rn.description,
//	rn.dateprefix,rn.fromdate,rn.todate,rn.notetext,rn.sourcetext,rn.privatetext,a.createdate,rn.modified,rn.createdate
//	from relation a inner join relation b on a.rid=b.rid left join relationnotice rn on a.rid=rn.rid
//	where a.pid <> b.pid and a.pid=3 order by b.pid,a.rid,a.relationrow,rn.noticerow
	...
	public RelationNotice(int rnid,int rid,int surety,String tag,String type,String description,
			String datePrefix,String fromDate,String toDate,String place,String noteText,
			String sourceText,String privateText,Timestamp modified,Timestamp created){
		this.rnid=rnid;
		this.rid=rid;
