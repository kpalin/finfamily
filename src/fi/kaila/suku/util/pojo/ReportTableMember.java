...
public class ReportTableMember implements Serializable {
	...
	/**
	 * When Pid in more than one table the # of the occurrence
	 * 0 = The only occurrence
	...
	public void addAsChild(long asChild) {
		for (int i = 0; i < alsoAsChild.size(); i++) {
			if (asChild == alsoAsChild.get(i)) return;
		}
	 ...
	 * @param pid
	 * @param sex
	 * @param strado (2 = father, 3 = mother etc)
	 */
...
//	}
	...
	/**
	 * @param refTableNo the refTableNo to set
	 */
	...
	/**
	 * @param refTable the refTid to set
	 */
	...
	/**
	 * @param pidOrder the pidOrder to set
	 */
	...
	/**
	 * @param spouses the subMembers to set
	 */
	...
	/**
	 * 
	 * Container for persons ancestors
	 * Used for not relative spouse andcestors or
	 * not relative child ancestor
	 * numbering as in Stradoniz numbering scema
	...
	class SubPersonMember implements Comparable{
		...
		public int compareTo(Object arg) {
			...
			if (stradoNum <othernum) return -1;
			if (stradoNum > othernum ) return 1;
			return 0;
		}
	}
