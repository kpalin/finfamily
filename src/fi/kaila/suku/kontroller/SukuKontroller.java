 ...
 * 
 * 
 * <p>The UI interacts with the data using this interface
 * There will be a separate implementation for local and the webstart version</p>
 * 
 * @author Kalle
 *
 *  
...
public interface SukuKontroller {
	...
	/**
	 * @param params variable # of request parameters
	 ...
	 * 
	 * Open of a local file. To make webstart possible all local 
	 * data management is made diffrently in the local Kontroller
	 * and the webstart kontrollr
	 * 
	 * @param filter
	 ...
	 * <h1>Local file management</h1>
	 * 
	 * Create a local file. To make webstart possible all local 
	 * data management is made diffrently in the local Kontroller
	 * and the webstart kontrollr
	 * @param filter
