...
public class AboutDialog extends JDialog implements ActionListener{
	...
	public AboutDialog(JFrame owner) {
       ...
       " from "+System.getProperty("java.vendor");
		...
		aux = Resurses.getString(Resurses.ABOUT_SUKU_VERSION) + " = "+ Suku.sukuVersion;
		logger.info(aux);
		about.append("- " +aux);
		about.append("\n");
		
		if (Suku.serverVersion != null) {
			aux = Resurses.getString(Resurses.ABOUT_SERVER_VERSION) + " = "+ Suku.serverVersion;
			about.append("- " +aux);
			about.append("\n");	
			logger.info(aux);
		}
		...
		if (Suku.postServerVersion != null) {
			...
			aux = Resurses.getString(Resurses.ABOUT_DB_VERSION) + " = "+ Suku.postServerVersion;
			about.append("- " +aux);
			about.append("\n");
			logger.info(aux);
		}
