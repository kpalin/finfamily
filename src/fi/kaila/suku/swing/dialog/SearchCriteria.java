...
/**
 * Window that is shown before database search is made
 * Windows contains the search criterias used in the search and columns to display 
 * 
 * @author FIKAAKAIL
 *
 */
public class SearchCriteria extends JDialog implements ActionListener {
	...
	private ColTable [] proptables = {new ColTable(Resurses.COLUMN_T_ALL_NAMES,true),
...
//				System.out.println("BB on " + bb + "/" + idx + "/" + tbl.getColName() + "/" + tbl.getCurrentState());
...
//				System.out.println("ContructColtable:" + idx + "=" + bb);
		...
		for (idx = 0; idx < this.proptables.length; idx++) {
			...
			this.colpanel.add(tbl.getChkBox());
			boolean bb = Utils.getBooleanPref(this, tbl.getColName(), tbl.getCurrentState());
			tbl.getChkBox().setSelected(bb);
...
//		
		...
		createdFromDate.setText(Suku.kontroller.getPref(this, "createdFromDate", ""));
		createdToDate.setText(Suku.kontroller.getPref(this, "createdToDate", ""));
	...
	/**
	 * @author FIKAAKAIL
	 * inner class for column for the table
	 */
	...
	public String getCriteriaField(int idx) {
		int vid;
		switch (idx){
		case 0: return this.surname.getText();
		case 1: return this.givenname.getText();
		case 2: return this.patronyme.getText();
		case 3: return this.birtFromDate.getText();
		case 4: return this.birtToDate.getText();
		case 5: return this.birtPlace.getText();
		case 6: return this.deatFromDate.getText();
		case 7: return this.deatToDate.getText();
		case 8: return this.deatPlace.getText();
		case 9: return this.createdFromDate.getText();
		case 10: return this.createdToDate.getText();
		case 11:  vid = this.getViewId();
				if (vid == 0) return null;
				else return ""+vid;
		case 12: return this.viewGroup.getText();
		case 13: return "yes";
		default: return null;
		}
	}
	...
	public String getFieldName(int idx) {
		switch (idx) {
		case 0: return Resurses.CRITERIA_SURNAME;
		case 1: return Resurses.CRITERIA_GIVENNAME;
		case 2: return Resurses.CRITERIA_PATRONYME;
		case 3: return Resurses.CRITERIA_BIRT_FROM;
		case 4: return Resurses.CRITERIA_BIRT_TO;
		case 5: return Resurses.CRITERIA_BIRT_PLACE;
		case 6: return Resurses.CRITERIA_DEAT_FROM;
		case 7: return Resurses.CRITERIA_DEAT_TO;
		case 8: return Resurses.CRITERIA_DEAT_PLACE;
		case 9: return Resurses.CRITERIA_CREATED_FROM;
		case 10: return Resurses.CRITERIA_CREATED_TO;
		case 11: return Resurses.CRITERIA_VIEW;
		case 12: return Resurses.CRITERIA_GROUP;
		case 13: return Resurses.CRITERIA_RELATIVE_INFO;
		default: return null;
		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd.equals(Resurses.RESET)){
			...
			Suku.kontroller.putPref(this, "birtFromDate", birtFromDate.getText());
			Suku.kontroller.putPref(this, "birtToDate", birtToDate.getText());
			Suku.kontroller.putPref(this, "birtPlace", birtPlace.getText());
			
			Suku.kontroller.putPref(this, "deatFromDate", deatFromDate.getText());
			Suku.kontroller.putPref(this, "deatToDate", deatToDate.getText());
			Suku.kontroller.putPref(this, "deatPlace", deatPlace.getText());
			
			Suku.kontroller.putPref(this, "createdFromDate", createdFromDate.getText());
			Suku.kontroller.putPref(this, "createdToDate", createdToDate.getText());
