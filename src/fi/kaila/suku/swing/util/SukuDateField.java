...
public class SukuDateField extends JPanel{
	...
	public boolean isPlain(){
		if (datePref.getSelectedIndex()==0) return true;
		return false;
	}
...
//			dateTo.setVisible(false);
		...
		if (pre != null) {
			if (pre.equals("ABT")) preIdx= 1;
			if (pre.equals("CAL")) preIdx= 2;
			if (pre.equals("EST")) preIdx= 3;
			if (pre.equals("BET")) preIdx= 4;
			if (pre.equals("FROM")) preIdx= 5;
			if (pre.equals("BEF")) preIdx= 6;
			if (pre.equals("AFT")) preIdx= 7;
